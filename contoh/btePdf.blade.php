        ...
        <div style="padding:10px; border:2px solid;">
                <table class="" width="100%">
                        <thead>
                                ...
                                <tr class="text-center">
                                        <th class="border border-dark">
                                                <strong style="font-size:14px;">DETAIL OF BUSSINES TRIP EXPENSES (BTE)</strong>
                                        </th>
                                        <td class="border border-dark">
                ...
                <table class="mt-3" width="100%">
                    ...
                    @if($joblevel->grade == '1')
                                ...
                                <tr class="border border-dark" style="font-size:10px;">
                                        ...
                                        ?>
                                        <tr class="border border-dark" style="font-size:10px;">
                                                <td class="border border-dark text-center" rowspan="{{12+$count}}"></td>
                                        ...
                                        <tr class="border border-dark" style="font-size:10px;">
                                                <td class="border border-dark text-center" rowspan="9"></td>
                                        ...
                                        <tr class="border border-dark" style="font-size:10px;">
                                                ...
                                                <td class="border border-dark" colspan="3" style="padding-left:2%;">MEAL ALLOWANCE</td>
                                                <!-- <td class="border border-dark text-center"></td>
                                                <td class="border border-dark text-center"></td> -->
                                                <td class="border border-dark" style="text-align:right; padding-right:3%;" colspan="2">Rp {{number_format($form->uang_makan,0,',','.')}}</td>
                                        </tr>
                                        <tr class="border border-dark" style="font-size:10px;">
                                                <td class="border border-dark text-center">X.1.2</td>
                                                <td class="border border-dark" colspan="3" style="padding-left:2%;">POCKET MONEY</td>
                                                <!-- <td class="border border-dark text-center"></td>
                                                <td class="border border-dark text-center"></td> -->
                                                <td class="border border-dark" style="text-align:right; padding-right:3%;" colspan="2">Rp {{number_format($form->uang_saku,0,',','.')}}</td>
                                        </tr>
                                        <tr class="border border-dark" style="font-size:10px;">
                                                <td class="border border-dark text-center">X.1.3</td>
                                                <td class="border border-dark" colspan="3" style="padding-left:2%;">TRANSPORTATION</td>
                                                <!-- <td class="border border-dark text-center"></td>
                                                <td class="border border-dark text-center"></td> -->
                                                <td class="border border-dark" style="text-align:right; padding-right:3%;" colspan="2">Rp {{number_format($form->uang_pp,0,',','.')}}</td>
                                        </tr>
                                        <tr class="border border-dark" style="font-size:10px;">
                                                <td class="border border-dark text-center">X.1.4</td>
                                                <td class="border border-dark" colspan="3" style="padding-left:2%;">HOTEL</td>
                                                <!-- <td class="border border-dark text-center"></td>
                                                <td class="border border-dark text-center"></td> -->
                                                <td class="border border-dark" style="text-align:right; padding-right:3%;" colspan="2">Rp {{number_format($form->uang_hotel,0,',','.')}}</td>
                                        </tr>
                                        <tr class="border border-dark" style="font-size:10px;">
                                                <td class="border border-dark text-center">X.1.5</td>
                                                <td class="border border-dark" colspan="3" style="padding-left:2%;">LAUNDRY</td>
                                                <!-- <td class="border border-dark text-center"></td>
                                                <td class="border border-dark text-center"></td> -->
                                                <td class="border border-dark" style="text-align:right; padding-right:3%;" colspan="2">Rp {{number_format($form->uang_laundry,0,',','.')}}</td>
                                        </tr>
                                        <tr class="border border-dark" style="font-size:10px;">
                                                <td class="border border-dark text-center">X.1.6</td>
                                                <td class="border border-dark" colspan="3" style="padding-left:2%;">LOCAL TRANSPORTATION</td>
                                                <!-- <td class="border border-dark text-center"></td>
                                                <td class="border border-dark text-center"></td> -->
                                                <td class="border border-dark" style="text-align:right; padding-right:3%;" colspan="2">Rp {{number_format($form->uang_transport_dilokasi,0,',','.')}}</td>
                                        </tr>
                                        <tr class="border border-dark" style="font-size:10px;">
                                                <td class="border border-dark text-center">X.1.7</td>
                                                <td class="border border-dark" colspan="3" style="padding-left:2%;">TICKET</td>
                                                <!-- <td class="border border-dark text-center"></td>
                                                <td class="border border-dark text-center"></td> -->
                                                <td class="border border-dark" style="text-align:right; padding-right:3%;" colspan="2">Rp {{number_format($form->uang_tiket,0,',','.')}}</td>
                                        </tr>
                                        <tr class="border border-dark" style="font-size:10px;">
                                                <td class="border border-dark text-center">X.1.8</td>
                                                <td class="border border-dark" colspan="3" style="padding-left:2%;">COMMUNICATION</td>
                                                <!-- <td class="border border-dark text-center"></td>
                                                <td class="border border-dark text-center"></td> -->
                                                <td class="border border-dark" style="text-align:right; padding-right:3%;" colspan="2">Rp {{number_format($form->uang_komunikasi,0,',','.')}}</td>
                                        </tr>
                                        <tr class="border border-dark" style="font-size:10px;">
                                                <td class="border border-dark text-center">X.2</td>
                                                <td style="font-style: italic;" colspan="4" style="padding-left:2%;"><strong>TO THE AIRPORT</strong></td>
                                                <td class="border border-dark" style="text-align:right; padding-right:3%;" colspan="2">Rp {{number_format((int)$form->airport,0,',','.')}}</td>
                                        </tr>
                                        <tr class="border border-dark" style="font-size:10px;">
                                                <td class="border border-dark text-center">X.3</td>
                                                <td style="font-style: italic;" colspan="6" style="padding-left:2%;"><strong>ETC</strong></td>
                                        </tr>
                                        @if($form->lain != null)
                                        @for($i = 0 ; $i < $count ; $i++)
                                                <tr class="border border-dark" style="font-size:10px;">
                                                        @if($i==0)
                                                        <td class="border border-dark text-center" rowspan="{{$count}}"></td>
                                                        @endif
                                                        <td class="border border-dark text-center">X.3.{{$i+1}}</td>
                                                        <td class="border border-dark" colspan="3" style="padding-left:2%;">{{$data[$i]->datalain}}</td>
                                                        <!-- <td class="border border-dark text-center"></td>
                                                        <td class="border border-dark text-center"></td> -->
                                                        <td class="border border-dark" style="text-align:right; padding-right:3%;" colspan="2">Rp {{number_format((int)$data[$i]->nilailain,0,',','.')}}</td>
                                                </tr>
                                        @endfor
                                        @endif
                                        <tr class="border border-dark" style="font-size:10px;">
                                                ...
                                                <!-- <td colspan="3"></td> -->
                                                <td class="border border-dark" style="text-align:right; padding-right:3%;" colspan="2" >Rp {{number_format($form->uang_panjar,0,',','.')}}</td>
                                        </tr>
                                        <tr class="border border-dark" style="font-size:10px;">
                                                <!-- <td></td> -->
                                                <td class="border border-dark text-center" style="font-style: italic;" colspan="6"><strong>FINAL</strong></td>
                                                <!-- <td colspan="3"></td> -->
                                                <td class="border border-dark" style="text-align:right; padding-right:3%;font-weight:bold;" colspan="2">Rp {{number_format($form->total,0,',','.')}}</td>
                                        </tr>
                        </tbody>
                </table>
